...
if tags != ['']:
    ...
    for finder in tags:
        ...
        if finder.find('$') == -1:
            ...
            if finder.find(':') != -1:
                lenta='https://www.avito.ru/'+region+'?pmin='+finder[finder.find('$')+1 : finder.find(':')]+'&pmax='+finder[finder.find(':')+1 : ]+'&q='+finder[:finder.find('$')]
            else:
                lenta='https://www.avito.ru/'+region+'?pmax='+finder[finder.find('$')+1 : ]+'&q='+finder[:finder.find('$')]
        ...
        # Here I got all the links, and I just to use them right
        for hrefs in etc:
            # Link is ready!
    ...
    for finder in tags:
        ...
        if finder.find('$') == -1:
            ...
            if finder.find(':') != -1:
                lenta='https://youla.ru/'+region+'?attributes[price][from]='+finder[finder.find('$')+1 : finder.find(':')]+'00&attributes[price][to]='+finder[finder.find(':')+1 : ]+'00&q='+finder[:finder.find('$')]
            else:
                lenta='https://youla.ru/'+region+'?attributes[price][to]='+finder[finder.find('$')+1 : ]+'00&q='+finder[:finder.find('$')]
            finder = finder[:-finder.find('$')]
